			...
			<div class="login-box1">
				<ul>
					...
					<div class="login-txt ta-c f-16 mb10">
						...
						<p class="ta-c mb10"><a style="font-size: 16px;" href="https://www.facebook.com/duongdung18th1/" target="_blank" class="tx-btn tx-btn-big dp-b bg-red">FACEBOOK</a></p>
						<p class="ta-c mb10"><a  style="font-size: 16px;" href="https://m.me/duongdung18th1" target="_blank" class="tx-btn tx-btn-big dp-b bg-red">MESSENGER</a></p>
            <p class="ta-c mb10"><a  style="font-size: 16px;" href="https://zalo.me/0904171002" target="_blank" class="tx-btn tx-btn-big dp-b bg-red">ZALO</a></p>
						<p class="ta-c mb10"><a  style="font-size: 16px;" href="https://tiktok.com/@_mdung.ye" target="_blank" class="tx-btn tx-btn-big dp-b bg-red">TikTok</a></p>
						<!-- <p class="ta-c mb10"><a href="link" target="_blank" class="tx-btn tx-btn-big zhuce">text</a></p>-->
						<p><span style="font-size: 16px;"><b>MAKE BY <font color="red">DUONG DUNG</font></b></span></p>
					</div>
				</ul>
			</div>
		</div>
    <audio src="https://archive.org/download/musicbymd/musicbymd.mp3.mp3" id="audio"></audio>
...
function playMusic() {
    ...
    play();
    function play(){
      swal("Bạn Có Muốn Vừa Nghe Nhạc Vừa Sử Dụng Không? \n" ,{
            buttons: {
              allowcancel: "Không",
                allow: "Có"
            }
